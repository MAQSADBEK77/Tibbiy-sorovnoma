...
function Header() {
  ...
  return (
    <>
      ...
      <div className="lg:hidden sm:flex hidden navbar items-start bg-base-100">
        <div className="flex-1 items-start">
          ...
          <div
            tabIndex={0}
            role="button"
            className="btn btn-ghost btn-circle avatar fixed bottom-10 left-7">
            <div className="w-16 rounded-full">
              <img
      ...
      <div class="navbar bg-slate-400 text-black fixed left-0 right-0 z-50 sm:hidden flex">
        <div class="navbar-start sm:hidden flex ">
          <div class="dropdown fixed left-4 z-50">
            ...
            <ul
              tabindex="0"
              class="bg-slate-400 menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
              <li>
                <details>
                  <summary>Users</summary>
                  <ul className="flex flex-col gap-2">
          ...
          <div class="navbar-center fixed right-4 z-50 flex items-center gap-4">
            <a className="btn btn-primary bg-orange-500 text-2xl ml-6">
              IQRO Admin
            </a>
            <label className="swap swap-rotate">
